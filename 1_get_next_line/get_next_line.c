...
void		lstdelone(void *content, size_t size)
{
	if (size > 0)
	{
...
int			safe_cat(char **str1, char **buf, size_t n)
{
	size_t	len;
	char	*result;
...
int			get_next_line_mult(t_bufs *bufs, char **line)
{
	int		s;
	size_t	n;
