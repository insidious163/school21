...
/*   Updated: 2018/11/25 14:38:07 by trhogoro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_rbtrmv(t_rbtree **elem, void	(*del)(t_rbtree *elem));
...
int				ft_rbtdcmp(t_rbtree *elem1, t_rbtree *elem2);
t_rbtree		*ft_rbt_c_new(void const *content, size_t content_size);
void			ft_rbtforeach_p(t_rbtree *root, void (*f)(t_rbtree *elem,
					void *params), int order, void *params);

int				ft_gnl(int fd, char **line);

t_lst2			*ft_lst2new(void *content, size_t size);
void			ft_lst2add_first(t_lst2 **root, t_lst2 *elem);
void			ft_lst2add_last(t_lst2 **root, t_lst2 *elem);
void			ft_lst2delone(t_lst2 **elem, void (*del)(void *, size_t));
void			ft_lst2del(t_lst2 **lst2, void (*del)(void *, size_t));
